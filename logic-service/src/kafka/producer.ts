/**
 * Kafka Producer
 * Gửi messages tới các service khác thông qua Kafka
 */
...
/**
 * Lấy hoặc tạo Producer singleton
 */
const getProducer = async (): Promise<Producer> => {
  ...
  producerInstance.on('producer.network.request', () => {
    // Tùy chọn: log network requests (debug only)
  });
...
/**
 * ===== PUBLIC METHODS - Gửi messages =====
 */

/**
 * Gửi request tới AI Service để trả lời Q&A
 */
...
/**
 * Gửi request tới AI Service để tóm tắt tài liệu
 */
...
/**
 * Báo Analytics Service rằng có submission mới
 */
...
/**
 * Báo Analytics Service rằng có grade mới
 */
...
/**
 * Generic publish - dùng cho edge cases
 * Thường dùng các functions cụ thể ở trên
 */
